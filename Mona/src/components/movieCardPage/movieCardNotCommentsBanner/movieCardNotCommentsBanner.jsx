...
const MovieCardNotCommentsBanner = ({ show, externalClass = "" }) => {
    let headerText = "Мы очень ждем ваших отзывов!";
    let text = "Пока никто не оставил отзывов на этот фильм. Напишите свой отзыв, поделитесь своим мнением о фильме со своими друзьями!";
